  ...
  <div class="header">
    <el-row>
      <el-col :span="2" :offset="1">
        <el-button round @click="closeAndBacktoMain" size="small">返回</el-button>
      </el-col>
      ...
      <el-col :span="2">
        <el-button round disabled icon="el-icon-d-arrow-right"  @click="forward" size="small">快进</el-button>
      </el-col>
      <el-col :span="2">
...
export default {
  ...
  methods: {
    ...
    runFrom: function (val) {
      // console.log(val, 'valOfProgrees')
      // this.recording.seek(this.percentageTime / 100 * this.max,()=>{})
      this.recording.seek((this.tempdate / 100 * this.max))
      // console.log(parseInt((this.percentageTime / 100 * this.max) / 1000) * 1000, 'percent')
    },
